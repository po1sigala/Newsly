...
$(document).ready(function() {
    ...
    var searchSites = function(search, source) {
      ...
      .then(function(response) {
        ...
        var newDiv = $("<div>")
          .addClass("post-image");
        //variable that contains the div that the card image goes 
      ...
      var publishDate= $("<span>").addClass("author").text(response.articles[0].publishedAt);
      var whenPublished= $("<div>").addClass("post-meta");
      whenPublished.append(publishDate);
  
        var newsContentDiv = $("<div>").addClass("news-content");
        newsContentDiv
          .append(categoryTitle)
          .append(whenPublished)
          .append(header)
          .append(summary)
          .append(linktosite);
        //
